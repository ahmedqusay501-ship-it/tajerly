...
const I18N = {
  ar: {
    ...
    home_market_title: 'تصفح كل المنتجات',
    home_market_sub: 'زبون؟ تسوق من كل المتاجر بمكان وحد',
    market_page_title: 'السوق العام',
    market_page_sub: 'كل منتجات كل المتاجر بمكان وحد',
    market_search_placeholder: 'دور عن منتج أو اسم محل...',
    market_filter_all: 'الكل',
    market_empty: 'ما فيه منتجات مطابقة حالياً',
    market_go_store: 'زيارة المتجر',
    ...
    public_footer_get_store: 'إذا كنت صاحب بيج أو تاجر وحاب تنضم وياتنا مجاناً، اضغط على الرابط',
    public_footer_visit_market: '🛒 سوق تاجرلي — تصفح كل المتاجر',
    ...
    nav_delivery_agents: 'مندوبين التوصيل',
    nav_agent_accounts: 'حسابات المندوبين',
    nav_my_deliveries: 'طلباتي للتوصيل',
    nav_admin_tools: 'إجراءات حساسة',
    nav_store_preview: 'معاينة المتاجر',
    nav_support: 'دعم التجار والمندوبين',
  ...
  en: {
    ...
    home_market_title: 'Browse All Products',
    home_market_sub: 'Shopping? Browse every store in one place',
    market_page_title: 'General Market',
    market_page_sub: 'All products from every store, in one place',
    market_search_placeholder: 'Search by product or shop name...',
    market_filter_all: 'All',
    market_empty: 'No matching products right now',
    market_go_store: 'Visit store',
    ...
    public_footer_get_store: 'If you own a page or a business and want to join us for free, click the link',
    public_footer_visit_market: '🛒 Tajerly Market — browse all stores',
    ...
    nav_delivery_agents: 'Delivery Agents',
    nav_agent_accounts: 'Agent Accounts',
    nav_my_deliveries: 'My Deliveries',
    nav_admin_tools: 'Sensitive Actions',
    nav_store_preview: 'Preview Stores',
    nav_support: 'Merchant & Agent Support',
  ...
  ku: {
    ...
    home_market_title: 'گەڕان بەناو هەموو بەرهەمەکان',
    home_market_sub: 'کڕیارێت؟ لە هەموو فرۆشگاکان یەکجار بکڕە',
    market_page_title: 'بازاڕی گشتی',
    market_page_sub: 'هەموو بەرهەمەکانی هەموو فرۆشگاکان لە یەک شوێن',
    market_search_placeholder: 'بگەڕێ بەدوای بەرهەم یان ناوی مەحەڵ...',
    market_filter_all: 'هەموو',
    market_empty: 'هیچ بەرهەمێکی گونجاو نیە ئێستا',
    market_go_store: 'سەردانی فرۆشگا',
    ...
    public_footer_get_store: 'ئەگەر خاوەن پەیجی یان بازرگانیت و دەتەوێت بەخۆڕایی بەشداریمان بکەیت، لینکەکە کرتە بکە',
    public_footer_visit_market: '🛒 بازاڕی تاجەرلی — گەڕان بەناو هەموو فرۆشگاکان',
    ...
    nav_delivery_agents: 'نوێنەرانی گەیاندن',
    nav_agent_accounts: 'حیسابی نوێنەران',
    nav_my_deliveries: 'گەیاندنەکانم',
    nav_admin_tools: 'کردارە هەستیارەکان',
    nav_store_preview: 'بینینی فرۆشگاکان',
    nav_support: 'پشتگیری فرۆشیار و نێردراوان',
